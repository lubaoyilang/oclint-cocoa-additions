#
#  Be sure to run `pod spec lint oclint-cocoa-additions.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/oclint/oclint-cocoa-additions.git", :tag => "v#{s.version}" }
